...
- An ***output path*** is simply `block_index/tx_index/output_index`. That is a succinct pointer to address any output contained in the blockchain. SPV proofs prove output paths. 
